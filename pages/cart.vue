...
const cartItemList = ref([
  {
    ...
    quantity: 1,
    image:
      'https://res.cloudinary.com/dbfvtcjog/image/upload/v1751192048/ihp5oimbsm9sopxvoi53.jpg',
    unit: '個'
  },
  {
    id: '1',
    ...
    <div v-else>
      ...
      <div class="mt-6 flex flex-col md:hidden">
        ...
        >
          ...
          >
            <img :src="item.image" class="w-20 h-20 rounded-3" alt="" />
            <button
          ...
          >
            ...
            <div class="flex items-center">
              ...
              <button class="h-8 w-8 hover:bg-primary hover:text-white bg-white border border-solid border-primary text-primary rounded-l-[50%]  cursor-pointer transition-all duration-200">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
              ...
              <span class="bg-white h-8 w-8 text-center flex items-center justify-center box-border  border-t border-b border-l-0 border-r-0 border-solid border-primary">{{ item.quantity }}</span>
              <button class="h-8 w-8 hover:bg-primary hover:text-white bg-white border border-solid border-primary text-primary rounded-r-[50%]  cursor-pointer transition-all duration-200">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
